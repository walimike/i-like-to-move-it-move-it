...
Instrument.create!([{
  ...
  condition: "Excellent",
  price: "2999",
  image: Rails.root.join("app/assets/images/book.jpg").open,
  user_id: user.id
},
{
  title: "Car",
  ...
  condition: "Used",
  price: "2595",
  image: Rails.root.join("app/assets/images/car.jpeg").open,
  user_id: user.id
},
{
  title: "Clothes",
...
The nitro-cellulose lacquer finish and our proprietary antiquing process make each Classic Antique™ feel like it has been loved for years. The Classic Antique now includes: our innovative SSCII (Silent Single-Coil) hum cancelling system, a vintage tinted nitrocellulose neck with stainless steel frets, and a Maple fingerboard option.",
  condition: "New",
  price: "2845",
  image: Rails.root.join("app/assets/images/clothes.jpeg").open,
  user_id: user.id
},
{
  title: "Bag",
  ...
  condition: "Used",
  price: "599",
  image: Rails.root.join("app/assets/images/bag.jpeg").open,
  user_id: user.id
},
{
